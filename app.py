...
tab1, tab2, tab3, tab4 = st.tabs(["📋 ACTIVE", "🏛️ VAULT", "💰 CONVERTER", "🔐 ENTRY"])
...
st.markdown("""
<div style="font-family: 'VT323', monospace; font-size: 1.1rem; margin: 10px 0; color: #000000;">
Live scores and betting lines for NFL, NCAAF, NBA, NCAAB, NHL, MLB, and NCAA Baseball:
</div>
""", unsafe_allow_html=True)
