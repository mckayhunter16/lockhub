...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["📋 ACTIVE", "🏛️ VAULT", "📸 SHARE", "💰 CONVERTER", "🔐 ENTRY"])
...
with tab3:
    ...
    ">
        <div style="
            ...
            margin-bottom: 15px;
        ">
            <span style="font-family: 'DotGothic16', sans-serif; font-size: 1.5rem; color: #000080; text-shadow: 1px 1px #ffff00;">
                🔒 LOCKHUB 🔒
            </span>
        </div>
        ...
        <div style="
            background-color: {'#00ff00' if fade_index > 0 else '#ff0000'};
            border: 3px outset #ffffff;
            padding: 15px;
            text-align: center;
        ">
            <div style="font-family: 'VT323', monospace; font-size: 2.5rem; color: {'#003300' if fade_index > 0 else '#ffffff'};">${fade_index:+.2f}</div>
            <div style="font-family: 'VT323', monospace; font-size: 1rem; color: {'#003300' if fade_index > 0 else '#ffffff'};">FADE INDEX</div>
        </div>
    ...
    st.markdown(share_card_html, unsafe_allow_html=True)
    
    st.markdown("""
    <div style="font-family: 'VT323', monospace; font-size: 1.1rem; text-align: center; margin: 20px 0; color: #000000;">
        📱 To share: Screenshot this card and send it!
    </div>
    """, unsafe_allow_html=True)
...
Record: {wins}W - {losses}L - {pushes}P"""
    ...
    <div class="info-box">
        <center>
        👆 Click the copy icon on the text box above to copy stats to clipboard!
        </center>
    </div>
    """, unsafe_allow_html=True)
