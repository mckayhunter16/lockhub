...
with tab5:
    ...
    # Determine colors based on indices
    glock_bg = "#00ff00" if glock_index > 0 else "#ff0000"
    glock_text = "#003300" if glock_index > 0 else "#ffffff"
...
<div style="text-align: center; margin-bottom: 15px; font-family: VT323, monospace; font-size: 1.8rem; color: #00ff00; background-color: #000080; padding: 10px; border: 3px outset #ffffff;">{wins}W - {losses}L - {pushes}P</div>
...
<div style="background-color: {glock_bg}; border: 3px outset #ffffff; padding: 15px; margin-bottom: 10px; text-align: center;">
